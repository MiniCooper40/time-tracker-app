...
import {Text, ButtonText, Dialog, Square, XStack, YStack, Button, Label, Adapt, Sheet, Circle} from "tamagui";
        ...
        <YStack>
            ...
            <Dialog modal open={open} onOpenChange={setOpen}>
                <Dialog.Trigger asChild>
                    <Button pressStyle={{backgroundColor: field.value}} backgroundColor={field.value} flexGrow={1}
                ...
                <Dialog.Portal>
                    ...
                    <Dialog.Content key="content" style={{justifyContent: "center", alignItems: "center"}}>
                        <YStack justifyContent="center" alignItems="center" gap="$4">
                            <XStack gap="$8">
                                <XStack gap="$4" width="100%" flexWrap="wrap"
                                        style={{width: "100%", flexWrap: "wrap", justifyContent: "space-evenly"}}>
                                    {colors.map(([rgb, hex], index) => (
                                        <Circle key={`${hex}-${index}`} size={50} backgroundColor={hex}
                                                onPress={() => {
                                ...
                                <Dialog.Close
                                    onPress={() => tempColorSelection ? helpers.setValue(tempColorSelection) : undefined}>
