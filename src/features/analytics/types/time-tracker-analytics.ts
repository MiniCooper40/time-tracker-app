...
export type TimeTrackerOverviewWeeklyAnalytics = TimeTrackerAnalytics &
  StartDatable;
...
export type TimeTrackerOverviewMonthlyAnalytics =
  {} & TimeTrackerOverviewWeeklyAnalytics;
export type TimeTrackerGranularMonthlyAnalytics =
