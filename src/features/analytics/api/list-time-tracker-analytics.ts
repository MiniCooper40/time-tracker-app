...
import {
  getTimeTrackerAnalytics,
  queryKeysForAnalyticsRequest,
...
export const useListTimeTrackerGranularDailyAnalytics = (
  trackerIds: string[],
  date: TrackingDate,
) => {
...
export const useListTimeTrackerOverviewDailyAnalytics = (
  trackerIds: string[],
  date: TrackingDate,
) => {
...
export const useListTimeTrackerGranularWeeklyAnalytics = (
  trackerIds: string[],
...
export const useListTimeTrackerOverviewWeeklyAnalytics = (
  trackerIds: string[],
  startDate: TrackingDate,
) => {
...
export const useListTimeTrackerGranularMonthlyAnalytics = (
  trackerIds: string[],
  month: TrackingMonth,
) => {
...
export const useListTimeTrackerOverviewMonthlyAnalytics = (
  trackerIds: string[],
  startDate: TrackingDate,
) => {
...
export const useListTimeTrackerGranularYearlyAnalytics = (
  trackerIds: string[],
  startDate: TrackingDate,
) => {
...
export const useListTimeTrackerOverviewYearlyAnalytics = (
  trackerIds: string[],
  startDate: TrackingDate,
) => {
...
function useListTimeTrackerAnalytics<T>({
  trackerIds,
  ...analyticsRequest
}: ListTimeTrackerAnalyticsRequest) {
  return useQueries(
    trackerIds.map((trackerId) => ({
      queryFn: () =>
        getTimeTrackerAnalytics<T>({
          ...analyticsRequest,
          trackerId,
        }),
